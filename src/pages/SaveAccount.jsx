      ...
      <section className="login-section__container account__container">
        ...
        <form action="/" className="form account__form">
          ...
          <input
            type="text"
            id="name"
            placeholder="Camilo Perez"
            className="input account__input--name"
          />
          {/* Email */}
          ...
          <input
            ...
            className="input account__input--email"
          />
          {/* Contraseña */}
          ...
          <input
            ...
            id="password"
            placeholder="************"
            className="input account__input--password"
          />
        </form>
      </section>
      <a href="/account" className="primary-button account__button">
        Save
      </a>
    </main>
  );
